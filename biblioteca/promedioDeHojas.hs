...
promedioDeHojas :: [Libro] -> Float
promedioDeHojas biblioteca =  sumaDeCantDeHojas biblioteca / cantLibros biblioteca

cantLibros :: [Libro] -> Float
cantLibros = length

sumaDeCantDeHojas :: [Libro] -> Float
sumaDeCantDeHojas = sum . map cantHojas 

cantHojas :: (String, String, Float) -> Float
cantHojas (_,_, hojas) = hojas
